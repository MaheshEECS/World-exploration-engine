...
public class TETile {
    public final char character; // Do not rename character or the autograder will break.
    ...
    public TETile copyWithBackground(TETile t, Color backgroundColor) {
        return new TETile(t.character, t.textColor, backgroundColor, t.description, t.filepath, t.id);
    }
    ...
    public static TETile colorVariantBackground(TETile t, int dr, int dg, int db, Random r) {
        ...
        return t.copyWithBackground(t, c);
    }
