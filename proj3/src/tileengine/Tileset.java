...
public class Tileset {
    public static final TETile LIGHT = new TETile('•', Color.pink, Color.black, "light", 13);
    public static final TETile LIGHTSON = new TETile('•', Color.pink, Color.magenta, "light", 17);
    public static final TETile LIGHT1 = new TETile('.', new Color(128, 192, 128), new Color(180, 0, 180), "light", 14);
    public static final TETile LIGHT2 = new TETile('.', new Color(128, 192, 128), new Color(100,0 ,100 ), "light", 15);
    public static final TETile LIGHT3 = new TETile('.', new Color(128, 192, 128), new Color(50,0 ,50 ), "light", 16);
    public static final TETile AVATAR = new TETile('@', Color.white, Color.black, "you", 0);
    public static final TETile AVATAR_LIGHT1 = new TETile('@', Color.white,  new Color(180, 0, 180), "you", 0);
    public static final TETile AVATAR_LIGHT2 = new TETile('@', Color.white,  new Color(100,0 ,100 ), "you", 0);
    public static final TETile AVATAR_LIGHT3 = new TETile('@', Color.white,  new Color(50,0 ,50 ), "you", 0);
